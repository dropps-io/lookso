      ...
      <div className={styles.Content}>
        ...
        <section className={styles.MainSection}>
          <div>
            ...
            <img
              className={styles.ImpactImgPhoneSize}
              src={impactImage.src}
              alt="lookso presentation"
            />
        ...
        <section className={styles.HeadlinesSection}>
          ...
          <div className={styles.Headline}>
            ...
            <p
              ...
              className={!foldHeadlines[0] ? styles.UnfoldedHeadline : ''}
            >
              The data associated with a Universal Profile is always accessible regardless of the
              owner’s or the platform’s intentions. This is made possible through the use of
              decentralised platforms, namely{' '}
              <a href={'https://lukso.network/'} target={'_blank'} rel={'noreferrer'}>
                LUKSO
              </a>{' '}
              (blockchain) and{' '}
            ...
            <div
              ...
              className={styles.ToggleHeadline}
            >
              {foldHeadlines[0] ? '+' : '-'}
            </div>
          </div>
          <div className={styles.Headline}>
            ...
            <p
              ...
              className={!foldHeadlines[1] ? styles.UnfoldedHeadline : ''}
            >
              Through a social media interoperability standard proposed by the DROPPS team, your
              activity on LOOKSO (posts, comments, replies and follows) are linked solely to your
              Universal Profile and can be pulled by other social media platforms
            </p>
            <div
              onClick={() => {
                foldHeadline(1);
          ...
          <div className={styles.Headline}>
            ...
            <p
              ...
              className={!foldHeadlines[2] ? styles.UnfoldedHeadline : ''}
            >
              Besides traditional social media features (posts, followers etc) LOOKSO displays other
              on-chain activity associated with Universal Profiles in a user-friendly manner, like
              contract interactions and value transfers{' '}
            </p>
            <div
              onClick={() => {
                foldHeadline(2);
        ...
        <section className={styles.ThirdSection}>
          <div className={styles.LeftPart}>
            ...
            <p>
              The dApp’s current version is live only within the L16 testnet. Once LUKSO’s mainnet
              goes live we will roll out the definitive version of our platform, along with a
              user-friendly interface for linking your testnet activity to your mainnet Universal
              Profile
            </p>
          </div>
