...
const questions = [
    ...
    {
        title: 'Who is LOOKSO?',
        response: "LOOKSO was built by DROPPS. DROPPS intends on becoming a hub for services pertaining to digital assets in the <a href='https://lukso.network/' target='_blank'>LUKSO</a> blockchain ecosystem.<br><br>" +
    ...
    },
    {
        ...
        response: "Yes. Your post will be removed from LOOKSO and from your Universal Profile as well. However, it cannot be removed from decentralized storage.<br><br>"
